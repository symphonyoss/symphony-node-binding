...
class RequestModel extends EventEmitter {
	...
	static addGlobalOptions(options) {
		if (!RequestModel.globalOptions) {
			RequestModel.globalOptions = {};
		}
        	Object.assign(RequestModel.globalOptions, options || {});
	}
	...
	request (url, method, passedOptions)
	{
		...
		Object.assign(options, RequestModel.globalOptions || {});
